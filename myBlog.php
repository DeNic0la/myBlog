...
<head>
  ...
  <meta name="description" content="die Blogseite von myBlog">
    ...
    <div class="container">
        <div class="row justify-content-center content-row">
            <div class="media-container-column title col-12 col-lg-7 col-md-6">
                <h3 class="mbr-section-subtitle align-left mbr-light pb-3 mbr-fonts-style display-5">Hier Befindne sich die&nbsp;</h3>
                <h2 class="align-left mbr-bold mbr-fonts-style display-2">
                    Neun Neusten Beiträge</h2>
            </div>
            <div class="media-container-column col-12 col-lg-3 col-md-4">
                <div class="mbr-section-btn align-right py-4"><a class="btn btn-primary display-4" href="myBlog.php#services5-h">Mehr Beiträge</a></div>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="media-container-row">
            ...
            <div class="card p-3 col-12 col-md-6 col-lg-4">
                <div class="card-img pb-3">
                    <a href="myBlog.php"><span class="mbr-iconfont mbri-mobile"></span></a>
                </div>
                <div class="card-box">
                    <h4 class="card-title py-3 mbr-fonts-style display-7">
                        <a href="myPost.php?post=">B1</a></h4>
            ...
            <div class="card px-3 col-12">
                <div class="card-wrapper media-container-row media-container-row">
                    <div class="card-box">
                        <div class="top-line pb-3">
                            <h4 class="card-title mbr-fonts-style display-5">
                                <a href="Beitrag_12"></a><a href="Beitrag_12"><strong>Beitrag_12</strong></a></h4>
                            <p class="mbr-text cost mbr-fonts-style m-0 display-5">
                                Creator_12</p>
                        </div>
                        <div class="bottom-line">
            ...
            <div class="card px-3 col-12">
                <div class="card-wrapper media-container-row media-container-row">
                    <div class="card-box">
                        <div class="top-line pb-3">
                            <h4 class="card-title mbr-fonts-style display-5">
                                <a href="Beitrag_13"><strong>Beitrag_13</strong></a></h4>
                            <p class="mbr-text cost mbr-fonts-style m-0 display-5">
                                Creator_13</p>
                        </div>
                        <div class="bottom-line">
