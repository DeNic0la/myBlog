...
<head>
  ...
  <meta name="description" content="Die About seite von myBlog">
...
<section class="engine"><a href="https://mobirise.info/o">portfolio web templates</a></section><section class="header5 cid-rIy7y1FE3E mbr-fullscreen" id="header5-k">
...
<section class="toggle1 cid-rIy8fm9udz" id="toggle1-l">
                            ...
                            <div class="card-header" role="tab" id="headingOne">
                                <a role="button" class="collapsed panel-title text-black" data-toggle="collapse" data-core="" href="#collapse1_21" aria-expanded="false" aria-controls="collapse1">
                                    <h4 class="mbr-fonts-style display-5">
                                        <span class="sign mbr-iconfont mbri-arrow-down inactive"></span>Was ist myBlog ?</h4>
                                </a>
                            </div>
                            <div id="collapse1_21" class="panel-collapse noScroll collapse" role="tabpanel" aria-labelledby="headingOne">
                                <div class="panel-body p-4">
                                    <p class="mbr-fonts-style panel-text display-7">
                                       myBlog ist eine Projektarbeit von mir (Nicola Fioretti). Ich werde extern ausgebildet und habe im Rahmen meiner Ausbildung den Auftrag erhalten einen Blog zu erstellen. Ich habe Anforderungen mit Prioritäten erhalten, welche ich grösstenteils ignoriert habe. Ich habe diesen Blog nach eigenen Vorstellungen erstellt und an die Anforderungen angepasst.</p>
                                </div>
                            </div>
                        </div>
                        <div class="card">
                            <div class="card-header" role="tab" id="headingTwo">
                                <a role="button" class="collapsed panel-title text-black" data-toggle="collapse" data-core="" href="#collapse2_21" aria-expanded="false" aria-controls="collapse2">
                                    <h4 class="mbr-fonts-style display-5">
                                        <span class="sign mbr-iconfont mbri-arrow-down inactive"></span>&nbsp;Wieso muss ich mich einloggen ?</h4>
                                </a>

                            </div>
                            <div id="collapse2_21" class="panel-collapse noScroll collapse" role="tabpanel" aria-labelledby="headingTwo">
                                <div class="panel-body p-4">
                                    <p class="mbr-fonts-style panel-text display-7">Wenn du nicht eingeloggt bist siehst du nur die Besuchersicht. Du kannst keine Kommentare schreiben oder Beiträge erstellen.</p>
                                </div>
                            </div>
                        </div>
                        <div class="card">
                            <div class="card-header" role="tab" id="headingThree">
                                <a role="button" class="collapsed panel-title text-black" data-toggle="collapse" data-core="" href="#collapse3_21" aria-expanded="false" aria-controls="collapse3">
                                    <h4 class="mbr-fonts-style display-5">
                                        <span class="sign mbr-iconfont mbri-arrow-down inactive"></span>&nbsp;Wie kann ich Beiträge Schreiben ?</h4>
                                </a>
                            </div>
                            <div id="collapse3_21" class="panel-collapse noScroll collapse" role="tabpanel" aria-labelledby="headingThree">
                                <div class="panel-body p-4">
                                    <p class="mbr-fonts-style panel-text display-7">Wenn dein Account mindestens 5 Minuten alt ist kannst du Beiträge Schreiben.</p>
                                </div>
                            </div>
                        </div>
...
<section class="services1 cid-rIym0hSOL7" id="services1-m">
    <!---->
            ...
            <div class="card col-12 col-md-6 p-3 col-lg-4">
                <div class="card-wrapper">
                    ...
                    <div class="card-box">
                        ...
                        <p class="mbr-text mbr-fonts-style display-7">Diese Webseite wurde von Joshua erstellt. Joshua wird mit mir zusammen im Basislehrjahr Ausgebildet.</p>
                        <!--Btn-->
                        <div class="mbr-section-btn align-left"><a href="https://mobirise.co" class="btn btn-warning-outline display-4">
                                zu Joshua</a></div>
                    </div>
            ...
            <div class="card col-12 col-md-6 p-3 col-lg-4 last-child">
                <div class="card-wrapper">
                    ...
                    <div class="card-box">
                        ...
                        <p class="mbr-text mbr-fonts-style display-7">Diese Webseite wurde von Alessio erstellt. Alessio wird mit mir zusammen im Basislehrjahr Ausgebildet.</p>
                        <!--Btn-->
                        <div class="mbr-section-btn align-left"><a href="https://mobirise.co" class="btn btn-warning-outline display-4">
                                zu Alessio</a></div>
                    </div>
